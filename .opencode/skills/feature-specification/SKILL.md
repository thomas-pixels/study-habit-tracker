...
* SQLite is the required persistence layer for this project. Features that store data must use SQLite via Python's built-in `sqlite3` module. No ORMs, no cloud databases, no other file-based storage formats.
